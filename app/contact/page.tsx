            ...
            <div className="lg:col-span-2 space-y-8">
              <div>
                ...
                <p className="text-lg text-gray-600">
                  Kami siap menjawab pertanyaan Anda dan mendiskusikan bagaimana kami dapat membantu merek Anda menonjol.
                </p>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-display font-bold text-lg mb-1">Telepon</h3>
                  <a
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-display font-bold text-lg mb-1">Lokasi</h3>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-display font-bold text-lg mb-1">Media Sosial</h3>
                  <a
              ...
              <div className="bg-[#25D366]/10 border border-[#25D366]/20 rounded-xl p-6">
                ...
                <p className="text-gray-600 mb-4">Chat with us directly for quick responses.</p>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 btn bg-[#25D366] text-white hover:bg-[#20BA5A]"
                >
