...
export default function StickyWhatsApp() {
  ...
  const whatsappMessage = encodeURIComponent(
    'Halo Serasa Kreatif, saya tertarik diskusi tentang branding & social media. Bisa bantu jadwalkan meeting?'
  )
  ...
  return (
    <div className="fixed bottom-6 right-6 z-40 flex items-end gap-2">
      ...
      <button
        ...
        className="w-8 h-8 bg-gray-800 hover:bg-gray-700 text-white rounded-full flex items-center justify-center transition-all opacity-0 hover:opacity-100 group-hover:opacity-100"
      ...
      >
        ...
        <span className="font-medium hidden sm:block">Chat dengan kami</span>
      </a>
    </div>
  )
}
