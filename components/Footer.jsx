...
export default function Footer() {
  return (
    <footer className="text-white border-t border-primary-dark bg-primary">
      <div className="py-12 container-custom">
        <div className="grid grid-cols-2 gap-8 mb-12 md:grid-cols-3">
          {/* Contact Info */}
          <div>
            <div className="mb-4 text-sm tracking-wider text-gray-200 uppercase">KONTAK</div>
            <div className="space-y-2 text-sm">
              <p className="text-white">Bintaro, Tangerang Selatan</p>
              <p className="text-white">+62 812-8897-1453</p>
              <p className="text-white">hello@serasakreatif.id</p>
            </div>
          </div>

          {/* Social */}
          <div>
            <div className="mb-4 text-sm tracking-wider text-gray-200 uppercase">SOCIAL</div>
            <div className="space-y-2 text-sm">
              <a
          ...
          {/* Open Roles */}
          <div>
            <div className="mb-4 text-sm tracking-wider text-gray-200 uppercase">KARIR</div>
            <div className="space-y-2 text-sm">
              <Link
                href="/careers"
                className="block text-white transition-colors hover:text-accent"
        ...
        {/* Bottom Bar */}
        <div className="flex flex-col items-center justify-between gap-4 pt-8 text-xs text-white border-t border-primary-dark md:flex-row">
