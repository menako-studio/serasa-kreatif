...
export const hero = {
  ...
  headline: 'We Make Brands More Relatable to People',
  subhead: 'We boost your sales through digital strategy and creative excellence.',
...
export const services = {
  ...
  sectionIntro:
    'We combine creativity with strategy to create solutions that drive your business forward. From brand design to social media management, every service is designed to deliver real results.',
  ...
  items: [
    {
      ...
      description:
        'Designing digital products and intuitive user experiences to increase engagement and conversion.',
    },
    {
      title: 'Campaign & Content',
      description:
        'Integrated campaigns and creative content (visual, video, copy) that build stories and connections with your audience.',
    },
  ],
}
...
export const servicesPage = {
  ...
  heroDescription:
    'We partner with clients for Brand Design, Product & Experience, Campaign & Content, and CRM & Relationship Design services. We have expertise across various sectors to help SMEs grow and compete.',
  ...
  items: [
    {
      ...
      shortDescription: 'We manage your social media, building a consistent and engaging presence.',
      details: [
      ...
      preview: 'https://images.unsplash.com/photo-1515378791036-0648a3ef77b2?w=800&q=80', // Social Media Management
    },
    {
      title: 'Brand Building & Positioning',
      shortDescription: 'We craft your brand identity to resonate with your target audience.',
      details: [
      ...
      preview: 'https://images.unsplash.com/photo-1465101046530-73398c7f28ca?w=800&q=80', // Brand Building & Positioning
    },
    {
      title: 'Commercial Visual Production',
      shortDescription:
        'We produce high-quality visuals that showcase your products and brand story.',
      details: [
        'Product Photography',
      ...
      preview: 'https://images.unsplash.com/photo-1517694712202-14dd9538aa97?w=800&q=80', // Commercial Visual Production
    },
    {
      title: 'Advertising & Campaign Strategy',
      shortDescription:
        'We design and execute data-driven campaigns that boost awareness and conversion.',
      details: [
        'Paid Social Media Campaigns',
      ...
      preview: 'https://images.unsplash.com/photo-1504384308090-c894fdcc538d?w=800&q=80', // Advertising & Campaign Strategy
    },
    {
      title: 'Content Niche-Based Creation',
      shortDescription:
        'We tailor content with your audience’s niche, ensuring relevance, engagement, and impact.',
      details: [
        'Niche-Focused Content Strategy',
        'Copywriting & Storytelling',
        'Visual Content Production',
        'User-Generated Content (UGC) Management',
        'Engagement & Community-Focused Posts',
      ],
      preview: 'https://images.unsplash.com/photo-1515378791036-0648a3ef77b2?w=800&q=80', // Content Niche-Based Creation
    },
  ],
}
